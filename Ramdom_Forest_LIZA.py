...
# Load dataset
file_path = r"D:\Vs Code\Python_Project\Mini Project (Price Prediction)\Book1(Liza).csv"
...
# Define manual colors for actual and predicted prices
actual_colors = ['yellow', 'green', 'seagreen', 'darkorange', 'brown']
predicted_colors = ['lightyellow', 'yellowgreen', 'green', 'orange', 'rosybrown']
