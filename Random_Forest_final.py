...
# Load dataset
file_path = r"D:\Vs Code\Python_Project\Mini Project (Price Prediction)\Book1(Babin).csv"
...
actual_colors = ['red', 'crimson', 'green', 'coral', 'lightgreen', 'darkorange']
predicted_colors = ['pink', 'coral', 'seagreen', 'lightcoral', 'ivory', 'orange']
...
commodity_color_map = {
    commodity: commodity_custom_colors.get(commodity, color)  # Use predefined color, otherwise pick from seaborn palette
